...
const getEventLocation = require("./utils/getEventLocation");
...
class DataService {
    ...
    constructor(data) {
        ...
        this.onStateChanged = () => {
            ...
            const eventLocation = getEventLocation(lastUpdate, current.data.present);
            ...
            this.emit(EVENTS.AFTER_UPDATE, eventLocation, { type: parentDataType });
            this.bubbleObservers(eventLocation, { type: parentDataType });
        };
