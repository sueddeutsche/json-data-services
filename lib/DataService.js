...
class DataService {
    ...
    constructor(data) {
        ...
        this.onStateChanged = () => {
            ...
            if (eventLocation === false) {
                console.info("DataService abort update event -- nothing changed");
                return;
            }
            ...
            console.log("DataService notify update", eventLocation, changes);
    ...
    set(pointer, value, isSynched = false) {
        ...
        if (diffpatch.diff(currentValue, value) == null) {
            console.info("DataService abort update -- value not changed");
            return;
        }
